...
- (void)customerNavigationItemTitleView {
    ...
    _lblTitleCount.frame = CGRectMake(30, 26, 80, 14);
    _lblTitleCount.text = [NSString stringWithFormat:@"已勾选%ld人", _selectedArray.count];
