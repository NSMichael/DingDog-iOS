...
- (UIView *)configHeaderView {
    ...
    if (!_headerView) {
        _headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, 226)];
        ...
        _btnCanSee.layer.cornerRadius = 19;
        ...
        _btnCanNotSee.layer.cornerRadius = 19;
        ...
        _topView2 = [[UIView alloc] initWithFrame:CGRectMake(0, 58, kScreen_Width, 64)];
        [_headerView addSubview:_topView2];
        
        UILabel *lblIn = [UILabel new];
        lblIn.frame = CGRectMake(15, 15, 50, 18);
        lblIn.text = @"IN";
        lblIn.font = kFont16;
        ...
        lblInTip.frame = CGRectMake(15, 32, 50, 18);
        lblInTip.text = @"包含条件";
        ...
        imgArrowRight1.frame = CGRectMake(kScreen_Width-15-9, 24, 9, 16);
        imgArrowRight1.image = [UIImage imageNamed:@"img-arrow-right"];
        [_topView2 addSubview:imgArrowRight1];
        
        _lblInTags = [UILabel new];
        _lblInTags.frame = CGRectMake(80, 22, kScreen_Width-80-35, 20);
        ...
        lblEXTip.frame = CGRectMake(15, 32, 50, 18);
        lblEXTip.text = @"删除条件";
        ...
        imgArrowRight2.frame = CGRectMake(kScreen_Width-15-9, 24, 9, 16);
        imgArrowRight2.image = [UIImage imageNamed:@"img-arrow-right"];
        [_topView3 addSubview:imgArrowRight2];
        
        _lblEXTags = [UILabel new];
        _lblEXTags.frame = CGRectMake(80, 22, kScreen_Width-80-35, 20);
        ...
        imgSeparatorLine3.frame = CGRectMake(0, 63.5, kScreen_Width, 0.5);
