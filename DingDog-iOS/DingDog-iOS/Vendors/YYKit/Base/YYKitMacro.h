 ...
 */
        ...
        #define weakifyYYKit(object) autoreleasepool{} __weak __typeof__(object) weak##_##object = object;
        #else
        #define weakifyYYKit(object) autoreleasepool{} __block __typeof__(object) block##_##object = object;
        #endif
    #else
        #if __has_feature(objc_arc)
        #define weakifyYYKit(object) try{} @finally{} {} __weak __typeof__(object) weak##_##object = object;
        #else
        #define weakifyYYKit(object) try{} @finally{} {} __block __typeof__(object) block##_##object = object;
        #endif
    #endif
#endif

#ifndef strongifyYYKit
    #if DEBUG
        #if __has_feature(objc_arc)
        #define strongifyYYKit(object) autoreleasepool{} __typeof__(object) object = weak##_##object;
        #else
        #define strongifyYYKit(object) autoreleasepool{} __typeof__(object) object = block##_##object;
        #endif
    #else
        #if __has_feature(objc_arc)
        #define strongifyYYKit(object) try{} @finally{} __typeof__(object) object = weak##_##object;
        #else
        #define strongifyYYKit(object) try{} @finally{} __typeof__(object) object = block##_##object;
        #endif
    #endif
#endif
